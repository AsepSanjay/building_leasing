          ...
          <!-- sidebar menu: : style can be found in sidebar.less -->
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="/user/pesan"><i class="fa fa-circle-o"></i> Lakukan Pemesanan</a></li>
                <li><a href="/user/statuspesan"><i class="fa fa-circle-o"></i> Status Pemesanan</a></li>
                <li><a href="/user/riwayat"><i class="fa fa-circle-o"></i> Riwayat Pemesanan</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="/user/akun"><i class="fa fa-circle-o"></i> Pengaturan Akun</a></li>
              </ul>
            </li>
            </ul>
        </section>
